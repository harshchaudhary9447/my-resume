...
const Experience = () => {
    return (
        <Box w={'100%'}>
            <Heading pl={'.5rem'} color={"black"} fontSize={'16px'}>WORK EXPERIENCE </Heading>
            ...
            <HStack justifyContent={'space-between'} pt={'.5rem'}  >
                <Heading pl={'.5rem'} color={"black"} fontSize={'16px'}>React.js Developer Intern</Heading>
                <Text fontWeight={'bold'} color={'#444654'} pr={'1rem'}>
                    March 2023 - June 2023
                </Text>
            </HStack>
            <Heading pt={'.2rem'} pl={'.5rem'} color={'#444654'} fontSize={'15px'}>Front End Web Application Development and Software Testing </Heading>
            <Text display={'flex'} alignItems={"center"} pt={'.3rem'} pl={'.5rem'} fontSize={'14px'} >
                Certificate of Intership:
                <a style={{ paddingLeft: ".4rem", color: "#025050", display: "flex", alignItems: "center" }} href="https://drive.google.com/file/d/18ohlX1-Gbiu41Ozac2JJSumtI_YKOBDv/view?usp=drive_link" target='_blank' rel="noreferrer">
                    <span style={{ display: "flex", paddingLeft: ".2rem", color: "#025050", fontWeight: "bold" }} > Link  </span>
                    <span style={{ paddingLeft: ".4rem" }}>
                        <FaExternalLinkAlt />
                    </span>
            ...
            <Box color={"#444654"} p={'.5rem'} fontSize={'16px'} display={'flex'} flexDir={'column'} alignItems={"left"}>
                <Text ml={'1rem'} pr={"3rem"} fontSize={'14px'}>
                    <ul>
                        <li>
                            Developed a Job Portal for recruitment of teachers and professors in the university.
                        </li>
                        <li>
                        ...
                        <li>
                            Technologies used: React.js, Tailwind, Chakra UI, HTML, CSS, JavaScript
                        </li>
                        {/* <li>
